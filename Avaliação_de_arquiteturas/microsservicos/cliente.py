...
def buscar_compromissos(data_inicio, data_fim):
    url = f"http://localhost:5000/compromissos/pesquisa?data_inicio={data_inicio}&data_fim={data_fim}"
